        ...
        <div className="flex items-center justify-between mb-8 animate-in">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">Study topics and prepare for the quiz</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-8">
          ...
          {sermons.length === 0 && (
            <div className="glass rounded-2xl p-12 text-center border border-white/5">
              ...
              <p className="text-gray-400 font-medium">No topics available yet</p>
          ...
          {allDone ? (
            ...
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-800/50 text-gray-400">
                ...
                Complete all {sermons.length} topics to unlock the quiz
              </div>
