...
export default function JuniorQuestionsPage() {
  const params = useParams();
  const sermonId = parseInt(params.sermonId as string);
  
  const sermon = SermonData.find(s => s.id === sermonId && s.age_bracket === "junior");
  const questions = QuestionData.filter(q => q.sermon_id === sermonId && q.age_bracket === "junior");
