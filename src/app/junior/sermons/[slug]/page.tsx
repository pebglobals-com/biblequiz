...
export default function JuniorSermonArticlePage() {
  const params = useParams();
  const slug = params.slug as string;
  const sermon = SermonData.find(s => s.slug === slug && s.age_bracket === "junior");
  const sermonQuestions = QuestionData.filter(q => q.sermon_id === sermon?.id && q.age_bracket === "junior");
          ...
          <article className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            <div className="relative aspect-video bg-gradient-to-br from-blue-500 via-bible-600 to-purple-700">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <p className="mt-3 text-blue-100 text-lg max-w-2xl">{sermon.excerpt}</p>
              </div>
            </div>
                  ...
                  <div className="text-center">
                    <div className="inline-flex items-center gap-3 p-4 bg-gradient-to-r from-bible-50 to-purple-50 dark:from-bible-900/20 dark:to-purple-900/20 rounded-2xl mb-6">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 mt-1">{sermonQuestions.length} Q&A pairs to help you learn</p>
                      </div>
                    </div>
